        ...
        private void AddQuestions()
        {
            modelBuilder.Entity<Question>().HasData(
                new Question { QuestionId = 1, CertificationId = 1, HasMultipleAnswers = false, Text = "Shall we play a game?" },
                    ...
                    new Question { QuestionId = 144, CertificationId = 3, HasMultipleAnswers = true, Text = "Which of the following can be used to protect against DDos attacks.<br/>Choose <strong>2</strong> answers from the options givenbelow" },
                    ...
                    new Question { QuestionId = 176, CertificationId = 3, HasMultipleAnswers = false, Text = "A company wants to create standard templates for deployment of their infrastructure. Which AWS service can be used in this regard? Please choose one option." },
