    ...
    public class DataInjector
    {
        ...
        private void AddExplanations()
        {
            modelBuilder.Entity<Explanation>().HasData(
                ...
                new Explanation { ExplanationId = 124, Text = "The AWS Documentation mentions the following:<br/> AnIAM role is similar to a user, in that it is an AWS identity with permission policies that determine what the identitycan and cannot do in AWS. However, instead of beinguniquely associated with one person, a role is intended tobe assumable by anyone who needs it. Also, a role doesnot have stand ard long-term credentials (password oraccess keys) associated with it. Instead, if a user assumesa role, temporary security credentials are created dynamically and provided to the user.", QuestionId = 124 },
                ...
                new Explanation { ExplanationId = 132, Text = "The AWS Documentation mentions the following:<br/> Amazon EMR helps you analyze and process vastamounts of data by distributing the computational workacross a cluster of virtual servers running in the AWS Cloud. The cluster is managed using an open-source framework called Hadoop. Amazon EMR lets you focuson crunching or analyzing your data without having toworry about time-consuming setup, management, and tuning of Hadoop clusters or the compute capacity theyrely on.", QuestionId = 132 },
                ...
                new Explanation { ExplanationId = 174, Text = "The AWS Documentation mentions the following:<br/>Amazon Relational Database Service (Amazon RDS)makes it easy to set up, operate, and scale a relational database in the cloud. It provides cost-efficient and resizable capacity while automating time-consumingadministration tasks such as hardware provisioning, database setup, patching and backups. It frees you to focus on your applications so you can give them the fastperformance, high availability, security and compatibilitythey need.", QuestionId = 174 },
                new Explanation { ExplanationId = 175, Text = "The AWS Documentation mentions the following:<br/>Amazon CloudFront employs a global network of edgelocations and regional edge caches that cache copies of your content close to your viewers. Amazon CloudFront ensures that end-user requests are served by the closestedge location.", QuestionId = 175 },
                ...
                new Explanation { ExplanationId = 178, Text = "Amazon Route 53 provides highly available and scalable Domain Name System (DNS), domain name registration, and health-checking web services. It isdesigned to give developers and businesses an extremely reliable and cost effective way to route end users toInternet applications by translating names like example.com into the numeric IP addresses, suchas 192.0.2.1, that computers use to connect to each other.", QuestionId = 178 },
        ...
        private void AddQuestions()
        {
            modelBuilder.Entity<Question>().HasData(
                    ...
                    new Question { QuestionId = 37, CertificationId = 3, NumberOfCorrectAnswers = 1, Text = "You work for a company that is planning on usingthe AWS EC2 service. They currently create golden images of their deployed Operating system.<br/>Which of the following correspond to a golden image in AWS." },
                    new Question { QuestionId = 38, CertificationId = 3, NumberOfCorrectAnswers = 1, Text = "You are developing and planning on deployment anapplication onto the AWS Cloud. This application needs tobe PCI Compliance. Which of the below steps would ou carry out to ensure the compliance is met for the application. <br/>Choose <strong>2</strong> answers from the" },
                    ...
                    new Question { QuestionId = 41, CertificationId = 3, NumberOfCorrectAnswers = 1, Text = "A company is planning to use AWS to host critical resources. Most of their systems are business critical andneed to have response times less than 15 minutes. Which of the following support plans should they consider?" },
                    ...
                    new Question { QuestionId = 43, CertificationId = 3, NumberOfCorrectAnswers = 1, Text = "There is a requirement for storage of objects. The objects should be able to be downloaded via a URL. Which storage option would you choose?" },
                    ...
                    new Question { QuestionId = 72, CertificationId = 3, NumberOfCorrectAnswers = 1, Text = "There is a requirement to collect important metrics from AWS RDS and EC2 Instances. Which of the following services can help fr1lfil this requirement." },
                    ...
                    new Question { QuestionId = 101, CertificationId = 3, NumberOfCorrectAnswers = 1, Text = "When giving permission to users via the AWS Identity and Access Management tool, which of the following principles should be applied when grantingpermissions" },
                    ...
                    new Question { QuestionId = 104, CertificationId = 3, NumberOfCorrectAnswers = 1, Text = "Your company currently uses VM Templates to spinup virtual machines on their on-premise infrastructure.Which of the following can be used in a similar way tospin up EC2 instances on the AWS Cloud." },
                    ...
                    new Question { QuestionId = 153, CertificationId = 3, NumberOfCorrectAnswers = 1, Text = "When working on the costing for on-demand EC2 instances, which are the following are attributes which determine the costing of the EC2 Instance?<br/>Choose <strong>3/strong> answers from the options given below." },
                    ...
                    new Question { QuestionId = 157, CertificationId = 3, NumberOfCorrectAnswers = 1, Text = "You want to monitor the CPU utilization of an EC2 resource in AWS. Which of the below services can help inthis regard?" },
                    ...
                    new Question { QuestionId = 161, CertificationId = 3, NumberOfCorrectAnswers = 1, Text = "Which of the following is AWS managed database service provides processing power that is up to 5X fasterthan a traditional MySQL database?" },
                    ...
                    new Question { QuestionId = 164, CertificationId = 3, NumberOfCorrectAnswers = 1, Text = "When using On-Demand instances in AWS, which of the following is a false statement when it comes to the costing for the Instance?" },
