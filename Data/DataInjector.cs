    ...
    public class DataInjector
    {
        ...
        private void AddExplanations()
        {
            modelBuilder.Entity<Explanation>().HasData(
                ...
                new Explanation { ExplanationId = 5, Text = "The AWS documentation mentions the following: Amazon CloudWatch is a monitoring service for AWS cloud resources and the applications you run on AWS.You can use Amazon CloudWatch to collect and trackmetrics, collect and monitor log files, set alarms, and automatically react to changes in your AWS resources For more information on AWS CloudWatch, please refer to the below URL: https://aws.amazon.cmn/cloudwatch/l", QuestionId = 5 },
                new Explanation { ExplanationId = 6, Text = "Using CloudWatch trail , one can monitor all the API activity conducted on all AWS services. The AWS documentation additionally mentions the following:  AWS Cloud Trail is a service that enables governance, compliance, operational auditing, and risk auditing of your AWS account. With CloudTrail, you can log, continuously monitor, and retain account activity related to actions across your AWS infrastructure. CloudTrailprovides event history of your AWS account activity, including actions taken through the AWS ManagementConsole, AWS SDKs, command line tools, and other AWS s ervices. This event history simplifies security analysis, resource change tracking, and troubleshooting. For more information on AWS CloudTrail, please refer to the below URL: https://aws.amazon.com/cloudtrail/", QuestionId = 6 },
                new Explanation { ExplanationId = 7, Text = "Route53 allows for registration of new domain names in AWS The AWS Documentation additionally mentions the following:  Amazon Route 53 is a highly available and scalable cloud Domain Name System(DNS) web service. It is designed to give developers and businesses an extremely reliable and cost effective way toroute end users to Internet applications by translating names like www.example.com into the numeric IPaddresses like 192.0.2.1 that computers use to connect toeach other. Amazon Route 53 is fully compliant with IPv6as well. For more information on AWS Route53, please refer to the below URL:https://aws.amazon.com/route53/", QuestionId = 7 },
                new Explanation { ExplanationId = 8, Text = "It allows developers to easily work with the various AWS resources programmatically For more information on the various programming tools available for AWS, please refer to the below URL:https://aws.amazon.com/tools/", QuestionId = 8 },
                new Explanation { ExplanationId = 9, Text = "Each AZ is a set of one or more data centers. By deploying your AWS resources to multiple Availability Zones, you are designing with failure with mind. So if one AZ were to go down, the other NDS, would still be up and running and hence your application would be more fault tolerant. For more information on AWS Regions and NIA, please refer to the below URL:http: //docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Concepts/Regionsand Availability Zones.html", QuestionId = 9 },
                ...
                new Explanation { ExplanationId = 14, Text = "The entire of control of data within an AWS account is with the Account Owner. For more information on AWS Account identifiers, please refer to the below URL:http://docs.aws.amazon.com/general/latest/gr/acct-identifiershtml", QuestionId = 14 },
                new Explanation { ExplanationId = 15, Text = "The entire concept of decoupling components is to ensure that the different components of an applications can be managed and maintained separately. If all components are tightly coupled then when onecomponent goes down , the entire application would dodown. Hence it is always a better design practice to decouple application components. For more information on a decoupled architecture, please refer to the below URL:http://whatis.techtarget. com/definition/decoupled-architecture", QuestionId = 15 },
                new Explanation { ExplanationId = 16, Text = "Each AZ is a set of one or more data centers. By deploying your AWS resources to multiple Availability Zones , you are designing with failure with mind. So if oneAZ were to go down , the other AZ‘s would still be up and running and hence your application would be more fault tolerant. For more information on AWS Regions and NIA, please refer to the below URL:http: //docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Concepts. Regionsand AvailabilitVZones.html", QuestionId = 16 },
                ...
                new Explanation { ExplanationId = 18, Text = "The concept of Elasticity is the means of an application having the ability to scale up and scale downbased on demand. An example of such a service is the Auto Scaling service. For more information on AWS Auto Scaling service, please refer to the below URL:https://aws.amazon.com/autoscaling/", QuestionId = 18 },
                new Explanation { ExplanationId = 19, Text = "The AWS documentation mentions the following: Spot Instances are a cost-effective choice if you can be flexible about when your applications run and if your applications can be interrupted. For example, Spot Instances are well-suited for data analysis, batch jobs, background processing, and optional tasks. For more information on AWS Spot Instances, please refer to the below URL:http: //docs.aws.amazon.c0111/AWSEC2/latest/UserGuide/using-spot-instanceshtml", QuestionId = 19 },
                ...
                new Explanation { ExplanationId = 22, Text = "The AWS Documentation mentions the following: AWS Multi-Factor Authentication (MFA) is a simple best practice that adds an extra layer of protection on top of your user name and password. For more information on the AWS MFA, please refer to the below URL:https://aws.amazon.com/iam/details/mfa/", QuestionId = 22 },
                ...
                new Explanation { ExplanationId = 26, Text = "The AWS Documentation mentions the following: Amazon CloudFront is a web service that gives businesses and web application developers an easy and cost effectiveway to distribute content with low latency and high data transfer speeds. Like other AWS services, Amazon CloudFront is a self-service, pay-per-use offering, requiring no long term commitments or minimum fees.With CloudFront, your files are delivered to end-usersusing a global network of edge locations. For more information on CloudFront, please visit the https://aws.amazon.com/cloudfront/", QuestionId = 26 },
                ...
                new Explanation { ExplanationId = 37, Text = "The AWS Documentation mentions the following:  AnAmazon Machine Image (AMI) provides the information required to launch an instance, which is a virtual server in the cloud. You specify an AMI when you launch an instance, and you can launch as many instances from theAMI as you need. You can also launch instances from as many different AMIs as you need. For more information on Amazon Machine Images, please refer to the following https://docs.aws.amazon.com/AWSEC 2/latest/UserGuide/AMIs.html", QuestionId = 37 },
                ...
                new Explanation { ExplanationId = 39, Text = "Note that the AWS Console cannot be used to upload data onto Glacier. The console can only be used to create a Glacier vault which can be used to upload the data. For more information on uploading data onto Glacier, please refer to the following ", QuestionId = 39 },
                ...
                new Explanation { ExplanationId = 43, Text = "Amazon S3 is the perfect storage option. It alsoprovides the facility of assigning a URL to each object which can be used to download the object. For more information on AWS S3, please visit the https://aws.amazon.com/sg/", QuestionId = 43 },
                ...
                new Explanation { ExplanationId = 47, Text = "The Physical infrastructure is a responsibility of AWS and not with the customer. Hence it is not an advantage of moving to the AWS Cloud. And AWS provides securitymechanisms, but even the responsibility of security lies with the customer.", QuestionId = 47 },
                ...
                new Explanation { ExplanationId = 51, Text = "If you want a self-managed database, that means you want complete control over the database engine and the underlying infrastructure. In such a case you need to host the database on an EC2 Instance. For more information on EC2 Instances, please refer to the below URL: https://aws.amazon.com/ec2/", QuestionId = 51 },
                new Explanation { ExplanationId = 52, Text = "The AWS Documentation mentions the following: Amazon Aurora (Aurora) is a fully managed, MySQL- and PostgreSQL-compatible, relational database engine. It combines the speed and reliability of high-end commercial databases with the simplicity and cost-effectiveness of open-source databases. It delivers up tofive times the throughput of MySQL and up to three timesthe throughput of PostgreSQL without requiring changes tomost of your existing applications. For more information on Amazon Aurora, please refer to the below URL:https://docs.aws.a1nazon.com/AmazonRDS/latest/UserGuide/Aurora.Overview.html", QuestionId = 52 },
                new Explanation { ExplanationId = 53, Text = "The concept of Elasticity is the means of an application having the ability to scale up and scale down based on demand. An exalee of such a service is the Auto Scaling service. For more information on AWS Auto Scaling service, please refer to the below URL:https://aws.amazon.cmn/autoscaling/", QuestionId = 53 },
                new Explanation { ExplanationId = 54, Text = "The AWS Documentation mentions the following:  Aload balancer distributes incoming application traffic across multiple EC2 instances in multiple Availability Zones. This increases the fault tolerance of your applications. Elastic Load Balancing detects unhealthy instances and routes traffic only to healthy instances. For more information on the Elastic Load Balancer service, please refer to the below URL:https://docs.aws.amazon.com/e1asticloadbalancing/latest/classic/introduction.html", QuestionId = 54 },
                ...
                new Explanation { ExplanationId = 63, Text = "The AWS Documentation mentions the following: AWS Multi-Factor Authentication (MFA) is a simple best practice that adds an extra layer of protection on top of your user name and password. With MFA enabled, whena user signs in to an AWS website, they will be promptedfor their user name and password (the first factor-whatthey know), as well as for an authentication code fromtheir AWS MFA device (the second factor-what theyhave). Taken together, these multiple factors provideincreased security for your AWS account settings and resources. For more information on AWS MFA, please refer to the below URL:https://aws.amazon.com/iam/details/mfa/", QuestionId = 63 },
                new Explanation { ExplanationId = 64, Text = "The snapshot from the AWS Documentation shows the spectrum of the Disaster recovery methods. If you go to the further end of the spectrum you have the least time for downtime for the users. For more information on Disaster recovery techniques, please refer to the below URL:https://aws.amazon.com/blogs/aws/new-whitepaper-use-aws-for-disaster-recovery/", QuestionId = 64 },
                ...
                new Explanation { ExplanationId = 72, Text = "The AWS documentation mentions the following: Amazon CloudWatch is a monitoring service for AWS cloud resources and the applications you run on AWS.You can use Amazon CloudWatch to collect and trackmetrics, collect and monitor log files, set alarms, and automatically react to changes in your AWS resources. For more information on AWS CloudWatch, please refer to the below URL:https://aws.amazon.com/cloudwatch/", QuestionId = 72 },
                new Explanation { ExplanationId = 73, Text = "Using CloudWatch trail, one can monitor all the API activity conducted on all AWS services. The AWS Documentation additionally mentions the following:  AWS CloudTrail is a service that enables governance, compliance, operational auditing, and risk auditing of your AWS account. With CloudTrail, you can log, continuously monitor, and retain account activity related toactions across your AWS infrastructure. CloudTrailprovides event history of your AWS account activity, including actions taken through the AWS ManagementConsole, AWS SDKs, command line tools, and other AWS services. This event history simplifies security analysis, resource change tracking, and troubleshooting. For more information on AWS CloudTrail, please refer to the below URL: https://aws.amazon.com/cloudtrail/", QuestionId = 73 },
                ...
                new Explanation { ExplanationId = 82, Text = "The entire of control of data within an AWS accountis with the Account Owner. For more information on AWS Account identifiers, please refer to the below URL:http://docs.aws.amazon.com/general/latest/gr/acct-identifiershtml", QuestionId = 82 },
                new Explanation { ExplanationId = 83, Text = "The entire concept of decoupling components is toensure that the different components of an applications can be managed and maintained separately. If all components are tightly coupled then when onecomponent goes down, the entire application would dodown. Hence it is always a better design practice to decouple application components. For more information on a decoupled architecture, please refer to the below URL:http://whatis.techtarget.com/definition/decoupled-architecture", QuestionId = 83 },
                new Explanation { ExplanationId = 84, Text = "Each AZ is a set of one or more data centers. By deploying  your AWS resources to multiple Availability Zones, you are designing with failure with mind. So if one AZ were to go down, the other NDS, would still be up and running and hence your application would be more fault tolerant. For more information on AWS Regions and NIA, please refer to the below URL:http: //docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Concepts. Regionsand AvailabilityZones.html", QuestionId = 84 },
                new Explanation { ExplanationId = 85, Text = "As per the Shared Responsibilitv model, the Patching of the underlying hardware and physical security of AWS resources is the responsibility of AWS. For more information on AWS Shared Responsibility Model, please refer to the below URL:https://aws.amazon.com/compliance/Shared-responsibility-model/Disk disposal: Storage Device Decommissioning When astorage device has reached the end of its shelflife, AWS procedures include a decommissioning process that is designed to prevent customer data from being exposed to unauthorized individuals. AWS uses the techniques detailed in DoD 5220.22-M ('National Industrial SecurityProgram Operating Manual O or NIST 800-88('Guidelines for Media Sanitization') to destroy data aspart of the decommissioning process. Alldecommissioned magnetic storage devices are degaussedand physically destroyed in accordance with industry-stand ard practices. For more information on Diskdisposal, please refer to the below URL:https://d0.awsstatic.com/whitepapers/aws-security-whitepaper.pdf", QuestionId = 85 },
                ...
                new Explanation { ExplanationId = 88, Text = "The AWS Management console allows you to accessand manage Amazon Web Services through a simple and intuitive web-based user interface For more information on AWS console, please refer to the below URL:https://aws.amazon.com/console/", QuestionId = 88 },
                ...
                new Explanation { ExplanationId = 90, Text = "The AWS Documentation mentions the following: AWS Multi-Factor Authentication (MFA) is a simple best practice that adds an extra layer of protection on top of your user name and password. For more information onthe AWS MFA, please refer to the below URL:https://aws.amazon.com/iam/details/mfa/", QuestionId = 90 },
                new Explanation { ExplanationId = 91, Text = "The AWS Documentation mentions the following: AWS Elastic Beanstalk is an easy-to-use service For deploying and scaling web applications and servicesdeveloped with Java, .NET, PHP, Node.js, Python, Ruby, Go. and Docker on familiar servers such as ADache.Nginx, Passenger, and IIS. For more information onenabling AWS Elastic beanstalk, please refer to the below URL: https://aws.amazon.com/elasticbeanstalk/?p =tile", QuestionId = 91 },
                ...
                new Explanation { ExplanationId = 93, Text = "The AWS Documentation mentions the following: AWS continues to lower the cost of cloud computing For its customers. In 2014, AWS has reduced the cost ofcompute by an average of 30%, storage by an average of51% and relational databases by an average of 28%. AWS continues to drive down the cost of your IT infrastructure. For more information on this, please refer to the below URL: https://aws.amazon.com/economics/learn-more/", QuestionId = 93 },
                ...
                new Explanation { ExplanationId = 102, Text = "The AWS Documentation mentions the following: Amazon Elastic Compute Cloud (Amazon EC2) is a webservice that provides secure, resizable compute capacity in the cloud. It is designed to make web-scale cloudcomputing easier for developers. For more information on AWS EC2, please refer to the following https://aws.amazon.com/ec2/", QuestionId = 102 },
                new Explanation { ExplanationId = 103, Text = "The AWS Documentation mentions the following: A security group acts as a virtual firewall for your instance to control inbound and outbound trafficA network access control list (ACL) is an optional layer ofsecurity for your VPC that acts as a firewall for controllingtraffic in and out of one or more subnets. For more information on Security Groups, please refer to the following https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/VPC_SecurityGroups.html. For more information on Network Access Control Lists, please refer to the following https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/VPC_ACLs.html", QuestionId = 103 },
                ...
                new Explanation { ExplanationId = 110, Text = "Since the requirement is just for 3 months, then the best cost effective option is to use On-Demand Instances. For more information on AWS On-Demand Instances pricing, please visit the https://aws.amazon.com/ec2/pricing/on-demand/", QuestionId = 110 },
                ...
                new Explanation { ExplanationId = 112, Text = "With AWS, some of the benefits you have is the 'Pay as you go model' and not having the need to pay up front for using AWS resources. For more information on some of the benefits of moving to the AWS Cloud, please visit the https://aws.amazon.com/application-hosting/benefits/", QuestionId = 112 },
                new Explanation { ExplanationId = 113, Text = "The AWS Documentation mentions the following: AWS Database Migration Service helps you migrate databases to AWS quickly and securely. The source database remains fully operational during the migration, minimizing downtime to applications that rely on the database. The AWS Database Migration Service canmigrate your data to and from most widely usedcommercial and open-source databases. For more information on AWS Database migration, please refer to the below URL: https://aws.amazon.com/dms/", QuestionId = 113 },
                new Explanation { ExplanationId = 114, Text = "The AWS Documentation mentions the following: You can reduce the load on your source DB Instance byrouting read queries from your applications to the read replica. Read replicas allow you to elastically scale outbeyond the capacity constraints of a single DB instancefor read-heavy database workloads. For more information on Read Replicis, please refer to the below URL:https://aws.amazon.com/rds/details/read-replicas/", QuestionId = 114 },
                new Explanation { ExplanationId = 115, Text = "Regions correspond to different geographic locations in AWS. For more information on Regions and Availability Zones n AWS, please refer to the below URL:https://docs.aws.a1nazon.com/AmazonRDS/latest/UserGuide/Concepts. Regionsand Availability Zones.html", QuestionId = 115 },
                new Explanation { ExplanationId = 116, Text = "If you want a self-managed database, that means you want complete control over the database engine and the underlying infrastructure. In such a case you need to hostthe database on an EC2 Instance For more information on EC2 Instances, please refer to the below URL:https://aws.amazon.com/ec2/", QuestionId = 116 },
                ...
                new Explanation { ExplanationId = 118, Text = "The concept of Elasticity is the means of an application having the ability to scale up and scale downbased on demand. An example of such a service is the Auto Scaling service. For more information on AWS Auto Scaling service, please refer to the below URL: https://aws.amazon.cmn/autoscaling/", QuestionId = 118 },
                ...
                new Explanation { ExplanationId = 121, Text = "The AWS Documentation mentions the following: Use this calculator to compare the cost of running your applications in an on-premises or colocation environment toAWS. Describe your on-premises or colocationconfiguration to produce a detailed cost comparisonwith AWS. For more information on the TCO Calculator, please refer to the below URL:https://awstcoca1culator.com/", QuestionId = 121 },
                ...
                new Explanation { ExplanationId = 123, Text = "The AWS SDK can be plugged in for various programming languages. Using the SDK you can then call the required AWS services. For more information on thevarious tools available in AWS, please refer to the below URL: https://aws.amazon.com/tools/", QuestionId = 123 },
                new Explanation { ExplanationId = 124, Text = "The AWS Documentation mentions the following:  AnIAM role is similar to a user, in that it is an AWS identity with permission policies that determine what the identitycan and cannot do in AWS. However, instead of beinguniquely associated with one person, a role is intended tobe assumable by anyone who needs it. Also, a role doesnot have stand ard long-term credentials (password oraccess keys) associated with it. Instead, if a user assumesa role, temporary security credentials are created dynamically and provided to the user. For more information on IAM Roles, please refer to the below URL:https://docs.aws.amazon.com/IAM/latest/UserGuide/id_1‘oles.html", QuestionId = 124 },
                new Explanation { ExplanationId = 125, Text = "The AWS Documentation mentions the following: You can use the consolidated billing feature in AWS Organizations to consolidate payment for multiple AWS accounts or multiple AISPL accounts. With consolidated billing, you can see a combined view of AWS chargesincurred by all of your accounts. You also can get a costreport for each member account that is associated withyour master account. Consolidated billing is offered at noadditional charge. For more information on consolidated billing, please refer to the below URL:https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/consolidated-billing/l", QuestionId = 125 },
                ...
                new Explanation { ExplanationId = 129, Text = "The snapshot from the AWS Documentation shows the spectrum of the Disaster recovery methods. If you go to the further end of the spectrum you have the least timefor downtime for the users. For more information onDisaster recovery techniques, please refer to the below URL: https://aws.amazon.com/blogs/aws/new-whitepaper-use-aus-for-disaster-recovery/", QuestionId = 129 },
                new Explanation { ExplanationId = 130, Text = "The AWS Documentation mentions the following:  Amazon Inspector enables you to analyze the behavior of your AWS resources and helps you to identify potential security issues. Using Amazon Inspector, you can define a collection of AWS resources that you want to include inan assessment target. You can then create an assessment template and launch a security assessment run of thistarget. For more information on AWS Inspector, please refer to the below URL:https://docs.aws.amazon.com/inspector/latest/userguide/inspector_intro duction.html", QuestionId = 130 },
                ...
                new Explanation { ExplanationId = 135, Text = "The entire advantage of the AWS Cloud or any cloud system is the ability to have a highly available infrastructure and to use resources on demand For more information on advantages on using AWS, please refer to the below URL: httDs: //aws.amazon.com/application-hosting/benefits/", QuestionId = 135 },
                new Explanation { ExplanationId = 136, Text = "The AWS Documentation mentions the following:  CloudFront also integrates with AWS WAF, a web application firewall that helps protect web applications from common web exploits, and AWS Shield, a managed DDoS protection service that safeguards web applications running on AWS. For more information on AWS CloudFront, please refer to the below URL:https://aws.amazon.com/cloudfront/details/", QuestionId = 136 },
                ...
                new Explanation { ExplanationId = 163, Text = "The AWS Documentation mentions the following: AWS CloudTrail is a service that enables governance, compliance, operational auditing, and risk auditing of your AWS account. With CloudTrail, you can log, continuously monitor, and retain account activity related toactions across your AWS infrastructure. CloudTrail provides event history of your AWS account activity, including actions taken through the AWS ManagementConsole, AWS SDKs, command line tools, and other AWSservices. This event history simplifies security analysis, resource change tracking, and troubleshooting. For more information on AWS CloudTrail, please refer to the below URL: https://aws.amazon.com/cloudtrail/", QuestionId = 163 },
                ...
                new Explanation { ExplanationId = 175, Text = "The AWS Documentation mentions the following: Amazon CloudFront employs a global network of edgelocations and regional edge caches that cache copies of your content close to your viewers. Amazon CloudFront ensures that end-user requests are served by the closestedge location. For more information on AWS CloudFront, please visit the URL:https://aws.amazon.com/cloudfront/details/", QuestionId = 175 },
