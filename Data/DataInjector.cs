    ...
    public class DataInjector
    {
        ...
        private void AddExplanations()
        {
            modelBuilder.Entity<Explanation>().HasData(
                ...
                new Explanation { ExplanationId = 22, Text = "The AWS Documentation mentions the following: AWS Multi-Factor Authentication (MFA) is a simple best practice that adds an extra layer of protection on top of your user name and password. For more information onthe AWS MFA, please refer to the below URL:https://aws.amazon.com/iam/details/mfa/", QuestionId = 22 },
                ...
                new Explanation { ExplanationId = 52, Text = "The AWS Documentation mentions the following: Amazon Aurora (Aurora) is a fully managed, MySQL- and PostgreSQL-compatible, relational database engine. It combines the speed and reliability of high-end commercial databases with the simplicity and cost-effectiveness of open-source databases. It delivers up tofive times the throughput of MySQL and up to three timesthe throughput of PostgreSQL without requiring changes tomost of your existing applications. For more information on Amazon Aurora, please refer tothe below URL:https://docs.aws.a1nazon.com/AmazonRDS/latest/UserGuide/Aurora.Overview.html", QuestionId = 52 },
                ...
                new Explanation { ExplanationId = 72, Text = "The AWS documentation mentions the following: Amazon CloudWatch is a monitoring service for AWS cloud resources and the applications you run on AWS.You can use Amazon CloudWatch to collect and trackmetrics, collect and monitor log files, set alarms, and automatically react to changes in your AWS resources. For more information on AWS CloudWatch, please refer tothe below URL:https://aws.amazon.com/cloudwatch/", QuestionId = 72 },
                ...
                new Explanation { ExplanationId = 84, Text = "Each AZ is a set of one or more data centers. Bydeploying your AWS resources to multiple Availability Zones, you are designing with failure with mind. So if one AZ were to go down, the other NDS, would still be up and running and hence your application would be more fault tolerant. For more information on AWS Regions and NIA, please refer to the below URL:http: //docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Concepts. Regionsand AvailabilitVZones.html", QuestionId = 84 },
                ...
                new Explanation { ExplanationId = 90, Text = "The AWS Documentation mentions the following: AWS Multi-Factor Authentication (MFA) is a simple bestpractice that adds an extra layer of protection on top of your user name and password. For more information onthe AWS MFA, please refer to the below URL:https://aws.amazon.com/iam/details/mfa/", QuestionId = 90 },
                ...
                new Explanation { ExplanationId = 116, Text = "If you want a self-managed database, that means you want complete control over the database engine and the underlying infrastructure. In such a case you need to hostthe database on an EC2 Instance For more informationon EC2 Instances, please refer to the below URL:https://aws.amazon.com/ec2/", QuestionId = 116 },
                ...
                new Explanation { ExplanationId = 163, Text = "The AWS Documentation mentions the following: AWS CloudTrail is a service that enables governance, compliance, operational auditing, and risk auditing of your AWS account. With CloudTrail, you can log, continuously monitor, and retain account activity related toactions across your AWS infrastructure. CloudTrail provides event history of your AWS account activity, including actions taken through the AWS ManagementConsole, AWS SDKs, command line tools, and other AWSservices. This event history simplifies security analysis, resource change tracking, and troubleshooting. For more information on AWS Cloudtrail, please refer to the belowURL: https://aws.amazon.com/cloudtrail/", QuestionId = 163 },
        ...
        private void AddQuestions()
        {
            modelBuilder.Entity<Question>().HasData(
                new Question { QuestionId = 1, CertificationId = 1, HasMultipleAnswers = false, Text = "Shall we play a game?" },
                    new Question { QuestionId = 3, CertificationId = 3, HasMultipleAnswers = false, Text = "Which of the following is a benefit of Amazon Elastic Compute Cloud (Amazon <b>EC2</b>) over physical servers?" },
                    ...
                    new Question { QuestionId = 7, CertificationId = 3, HasMultipleAnswers = false, Text = "Which service should an administrator use to register a new domain name with AWS?" },
                    new Question { QuestionId = 8, CertificationId = 3, HasMultipleAnswers = false, Text = "What is the value of having AWS Cloud services accessible through an Application Programming Interface(API)?" },
                    ...
                    new Question { QuestionId = 17, CertificationId = 3, HasMultipleAnswers = false, Text = "Which of the following security requirements are managed by AWS customers? <br/>Select <strong>2</strong> answers from the options given below." },
                    ...
                    new Question { QuestionId = 19, CertificationId = 3, HasMultipleAnswers = false, Text = "Amazon Elastic Compute Cloud (Amazon EC2) Spot instances are appropriate for which of the following workloads?" },
                    ...
                    new Question { QuestionId = 29, CertificationId = 3, HasMultipleAnswers = false, Text = "You are currently hosting an infrastructure and most of the EC2 instances are near 90-100% utilized. What is the type of EC2 instances you would utilize to ensure costs are minimized?" },
                    ...
                    new Question { QuestionId = 34, CertificationId = 3, HasMultipleAnswers = true, Text = "What best describes the 'Principal of Least Privilege'?<br/>Choose the correct answer from the options given below:" },
                    new Question { QuestionId = 35, CertificationId = 3, HasMultipleAnswers = false, Text = "Which of the below mentioned services can be used to host virtual servers in the AWS Cloud?" },
                    new Question { QuestionId = 36, CertificationId = 3, HasMultipleAnswers = true, Text = "Which of the following can be used to protect EC2 Instances hosted in AWS<br/>Choose <strong>2</strong> answers from the options given below:" },
                    new Question { QuestionId = 37, CertificationId = 3, HasMultipleAnswers = false, Text = "You work for a company that is planning on usingthe AWS EC2 service. They currently create golden images of their deployed Operating system.<br/>Which of the following correspond to a golden image in AWS." },
                    ...
                    new Question { QuestionId = 39, CertificationId = 3, HasMultipleAnswers = true, Text = "Which of the below can be used to get data onto Amazon Glacier?<br/>Choose <strong>3</strong> answers from the options given below." },
                    ...
                    new Question { QuestionId = 46, CertificationId = 3, HasMultipleAnswers = true, Text = "When creating security groups, which of the following is a responsibility of the customer.<br/>Choose <strong>2</strong> answers from the options given below." },
                    new Question { QuestionId = 47, CertificationId = 3, HasMultipleAnswers = true, Text = "Which of the following are advantages of having infrastructure hosted on the AWS Cloud?<br/>Choose <strong>2</strong> answers from the options given below." },
                    new Question { QuestionId = 48, CertificationId = 3, HasMultipleAnswers = false, Text = "There is an external audit being carried out on your company. The IT auditor needs to have a log of all access to the AWS resources in the companys account. Which of the below services can assist in providing the details?" },
                    new Question { QuestionId = 49, CertificationId = 3, HasMultipleAnswers = false, Text = "Which of the following features of RDS allows for data redundancy across regions?" },
                    ...
                    new Question { QuestionId = 53, CertificationId = 3, HasMultipleAnswers = true, Text = "Which of the following statements are TRUE when itcomes to elasticity?<br/>Choose <strong>2</strong> answers from the options given below" },
                    ...
                    new Question { QuestionId = 55, CertificationId = 3, HasMultipleAnswers = false, Text = "Which of the following is the concept of Auto Scaling?" },
                    new Question { QuestionId = 57, CertificationId = 3, HasMultipleAnswers = false, Text = "Which of the following is the responsibility of the customer when ensuring that data on EBS volumes is safe?" },
                    ...
                    new Question { QuestionId = 61, CertificationId = 3, HasMultipleAnswers = true, Text = "Which of the following helps in DDos protection<br/>Choose <strong>2</strong> answers from the options given below?" },
                    ...
                    new Question { QuestionId = 72, CertificationId = 3, HasMultipleAnswers = false, Text = "There is a requirement to collect important metrics from AWS RDS and EC2 Instances. Which of the following services can help fr1lfil this requirement." },
                    new Question { QuestionId = 73, CertificationId = 3, HasMultipleAnswers = false, Text = "Which of the following services can provide acomplete audit trail of all AWS services used within an account?" },
                    ...
                    new Question { QuestionId = 77, CertificationId = 3, HasMultipleAnswers = false, Text = "Currently your organization has an operational team that takes care of ID management in their on-premise data center. They now also need to manage users and groups created in AWS. Which of the following AWS toolswould they need to use for performing this management function." },
                    new Question { QuestionId = 78, CertificationId = 3, HasMultipleAnswers = false, Text = "You have a devops team in your current organization's structure. They are keen to know if there is any service available in AWS which can be used to manage infrastructure as code. Which of the following can be met with such a requirement?" },
                    ...
                    new Question { QuestionId = 80, CertificationId = 3, HasMultipleAnswers = true, Text = "Which of the following is the responsibility of AWS according to the Shared Security Model?<br/>Choose <strong>3</strong> answers from the options given below" },
                    ...
                    new Question { QuestionId = 82, CertificationId = 3, HasMultipleAnswers = false, Text = "By default who from the below roles has complete administrative control over all resources in the respective AWS account?" },
                    ...
                    new Question { QuestionId = 92, CertificationId = 3, HasMultipleAnswers = false, Text = "Your company handles a crucial ecommerce application. This applications needs to have an uptime ofat least 99.5%. There is a decision to move the application tothe AWS Cloud. Which of the following deployment strategies can help build a robust architecture for such an application." },
                    ...
                    new Question { QuestionId = 107, CertificationId = 3, HasMultipleAnswers = true, Text = "Which of the following are features of an edge location?<br/>Choose <strong>3</strong> answers from the options given below." },
                    ...
                    new Question { QuestionId = 109, CertificationId = 3, HasMultipleAnswers = true, Text = "Which of the following features of Amazon RDS allows for better availability of databases?<br/>Choose <strong>2</strong> answers from the options given below." },
                    ...
                    new Question { QuestionId = 112, CertificationId = 3, HasMultipleAnswers = true, Text = "When working with the AWS Cloud which of the following are headaches you don't need to worry about.<br/>Choose <strong>2</strong> answers from the options given below." },
                    ...
                    new Question { QuestionId = 128, CertificationId = 3, HasMultipleAnswers = true, Text = "Which of the following are services where you don't need to manage the underlyng Infrastructure?<br/>Choose <strong>2</strong>  answers from the options given below." },
                    ...
                    new Question { QuestionId = 134, CertificationId = 3, HasMultipleAnswers = false, Text = "You are planning to serve a web application on the AWS Platform by using EC2 Instances. Which of the below principles would you adopt to ensure that even if some of the EC2 Instances crashes, you still have aworking application?" },
                    new Question { QuestionId = 135, CertificationId = 3, HasMultipleAnswers = true, Text = "Which of the following options would entice acompany to use AWS over an on-premises data center?<br/>Choose <strong>2</strong> answers from the options given below?" },
                    ...
                    new Question { QuestionId = 138, CertificationId = 3, HasMultipleAnswers = true, Text = "Which of the following are right principles when designing cloud based systems.<br/>Choose <strong>2</strong> answers fromt he options below?" },
                    ...
                    new Question { QuestionId = 143, CertificationId = 3, HasMultipleAnswers = false, Text = "You have a mission-critical application which must be globally available at all times. If this is the case, which of the below deployment mechanisms would you employ?" },
                    new Question { QuestionId = 144, CertificationId = 3, HasMultipleAnswers = true, Text = "Which of the following can be used to protect against DDos attacks?<br/>Choose <strong>2</strong> answers from the options given below." },
                    ...
                    new Question { QuestionId = 147, CertificationId = 3, HasMultipleAnswers = false, Text = "In order to predict the cost of moving resources from on-premise to the cloud, which of the following can be used?" },
                    new Question { QuestionId = 148, CertificationId = 3, HasMultipleAnswers = false, Text = "What is the concept of an AWS region?" },
                    new Question { QuestionId = 149, CertificationId = 3, HasMultipleAnswers = true, Text = "In AWS, which security aspects are the customer's responsibility?<br/>Choose <strong>4</strong> answers from the options given below." },
                    ...
                    new Question { QuestionId = 153, CertificationId = 3, HasMultipleAnswers = false, Text = "When working on the costing for on-demand EC2 instances , which are the following are attributes which determine the costing of the EC2 Instance?<br/>Choose <strong>3/strong> answers from the options given below." },
                    ...
                    new Question { QuestionId = 155, CertificationId = 3, HasMultipleAnswers = true, Text = "What are characteristics of Amazon S3?<br/>Choose <strong>2</strong> answers from the options given below." },
                    new Question { QuestionId = 156, CertificationId = 3, HasMultipleAnswers = false, Text = "What is the AWS service provided which provides a fully managed NoSQL database service that provides fast and predictable performance with seamless scalability." },
                    ...
                    new Question { QuestionId = 158, CertificationId = 3, HasMultipleAnswers = false, Text = "A company is deploying a 2-tier, highly available web application to AWS. Which service provides durable storage for static content while utilizing lower Overall CPU resources for the web tier?" },
                    ...
                    new Question { QuestionId = 165, CertificationId = 3, HasMultipleAnswers = false, Text = "AWS provides a storage option known as Amazon Glacier. What is this AWS service designed for?<br/>Please specify <strong>2</strong> correct options." },
                    new Question { QuestionId = 166, CertificationId = 3, HasMultipleAnswers = false, Text = "Which of the following is not a supported database in the AWS RDS service?" },
                    ...
                    new Question { QuestionId = 174, CertificationId = 3, HasMultipleAnswers = true, Text = "Which of the following are benefits of the AWS's Relational Database Service (RDS)?<br/>Choose <strong>2</strong> answers from the options below." },
                    ...
                    new Question { QuestionId = 176, CertificationId = 3, HasMultipleAnswers = false, Text = "A company wants to create standard templates for deployment of their infrastructure. Which AWS service can be used in this regard?<br/>Please choose <strong>one</strong> option." },
                    ...
                    new Question { QuestionId = 178, CertificationId = 3, HasMultipleAnswers = false, Text = "What is the service provided by AWS that lets you host Domain Name systems? Please choose an answer from the options below." },
                    new Question { QuestionId = 179, CertificationId = 3, HasMultipleAnswers = false, Text = "What is the service provided by AWS that allows developers to easily deploy and manage applications on the cloud? Please choose on answer from the options below." },
                    ...
                    new Question { QuestionId = 189, CertificationId = 3, HasMultipleAnswers = true, Text = "Which of the following are attributes to the costing for using the Simple Storage Service?<br/>Choose <strong>2</strong> answers from the options given below." },
                    ...
                    new Question { QuestionId = 191, CertificationId = 3, HasMultipleAnswers = false, Text = "Which of the following services helps provide a connection from on-premise infrastructure to resources hosted in the AWS Cloud?<br/>Choose <strong>2</strong> answers from the options given below" },
