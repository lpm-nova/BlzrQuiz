    ...
    public class DataInjector
    {
        ...
        private void AddExplanations()
        {
            modelBuilder.Entity<Explanation>().HasData(
                ...
                new Explanation { ExplanationId = 34, Text = "The principle means giving a user account only those privileges which are essential to perform its intended function. For example, a user account for the solepurpose of creating backups does not need to installsoftware: hence, it has rights only to run backup and backup-related applications. For more information onprinciple of least privilege, please refer to the followinghttps://en.wikipedia.org/wiki/Principle_of_least_privilege", QuestionId = 34 },
                new Explanation { ExplanationId = 35, Text = "The AWS Documentation mentions the following: Amazon Elastic Compute Cloud (Amazon EC2) is a webservice that provides secure, resizable compute capacityin the cloud. It is designed to make web-scale cloudcomputing easier for developers. For more informationon AWS EC2, please refer to the following https://aws.amazon.c01n/ec2/", QuestionId = 35 },
                ...
                new Explanation { ExplanationId = 42, Text = "The Edge location does not do the job of distributingload. It is used in conjunction with the Cloudfront serviceto cache the obj ects and deliver content.For more information on Cloudfront and Edgelocations, please refer to the following https://aws.amazon.com/cloudfront/details/", QuestionId = 42 },
                ...
                new Explanation { ExplanationId = 46, Text = "When you define security rules for EC 2 Instances, you give a name, description and write the rules for thesecurity group. For more information on AWS SecurityGroups, please visit the https://docs.aws.a1nazon.com/AWSEC 2/latest/UserGuide/using-network-security.)", QuestionId = 46 },
                new Explanation { ExplanationId = 47, Text = "The Physical infrastructure is a responsibility of AWSand not with the customer. Hence it is not an advantageof moving to the AWS Cloud. And AWS provides securitymechanisms, but even the responsibility of security lieswith the customer.", QuestionId = 47 },
                new Explanation { ExplanationId = 48, Text = "Using Cloudwatch trail , one can monitor all the APIactivity conducted on all AWS services. The AWS Documentation additionally mentions the following:  AWS CloudTrail is a service that enables governance, compliance, operational auditing, and risk auditing ofyour AWS account. With CloudTrail, you can log, continuously monitor, and retain account activity relatedto actions across your AWS infrastructure. CloudTrailprovides event history of your AWS account activity, including actions taken through the AWS ManagementConsole, AWS SDKs, command line tools, and other AWSservices. This event history simplifies security analysis, resource change tracking, and troubleshooting.", QuestionId = 48 },
                ...
                new Explanation { ExplanationId = 58, Text = "The AWS SDK can be plugged in for various programming languages. Using the SDK you can then callthe required AWS services.For more information on the various tools available inAWS, please refer to the below URL:https://aws.amazon.com/tools/", QuestionId = 58 },
                ...
                new Explanation { ExplanationId = 68, Text = "The AWS Documentation mentions the following:  onthe Simple Queue Service Amazon Simple Queue Service(Amazon SQS) offers a reliable, highly-scalable hostedqueue for storing messages as they travel betweenapplications or microservices. It moves data between distributed application components and helps youdecouple these components.For more information on AWS SQS, please refer to thebelow URL:https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/Welcome.html", QuestionId = 68 },
                ...
                new Explanation { ExplanationId = 118, Text = "The concept of Elasticity is the means of an application having the ability to scale up and scale downbased on demand. An example of such a service is theAutoscaling service. For more information on AWSAutoscaling service, please refer to the below URL: https://aws.amazon.cmn/autoscaling/", QuestionId = 118 },
                ...
                new Explanation { ExplanationId = 144, Text = "The AWS Documentation mentions the following:  AWS Shield - All AWS customers benefit from theautomatic protections of AWS Shield Stand ard, at noadditional charge. AWS Shield Stand ard defends against most common, frequently occurring network and transport layer DDoS attacks that target your web site orapplications AWS Shield Advanced - For higher levels ofprotection against attacks targeting your web applications running on Amazon EC2, Elastic Load Balancing (ELB), CloudFront, and Route 53 resources, you can subscribe toAWS Shield Advanced. AWS Shield Advanced provides expanded DDoS attack protection for these resources. For more information on AWS Shield, please refer tothe below URL:https://docs.aws.a1nazon.com/waf/latest/develop erguide/ddos-overview.html", QuestionId = 144 },
                ...
                new Explanation { ExplanationId = 164, Text = "You don''t need to pay any termination fees when itcomes to Ec2 Instances For more information on AWSEc2 On-demand pricing, please refer to the below URL:https://aws.amazon.com/e02/pricing/on-demand/", QuestionId = 164 },
                ...
                new Explanation { ExplanationId = 166, Text = "The AWS Documentation mentions the following: Amazon RDS is available on several database instancetypes - optimized for memory, performance or I/O - and provides you with six familiar database engines to choosefrom. including AmazonAurora, PostgreSQL, MySQL, MariaDB, Oracle, and Microsoft SQL Server. For more information on AWS RDS, please refer to the below URL:https://aws.amazon.com/rds/", QuestionId = 166 },
                new Explanation { ExplanationId = 167, Text = "The AWS Documentation mentions the following: AWS Snowball is a service that accelerates transferringlarge amounts of data into and out of AWS using physical storage appliances, bypassing the Internet. Each AWSSnowball appliance type can transport data at faster-thaninternet speeds. This transport is done by shipping theIdata in the appliances through a regional carrier. Theappliances are rugged shipping containers, complete withE Ink shipping labels. For more information on AWSSnowball, please refer to the below URL:https://docs.aws.amazon.com/snowball/latest/ug/whatissnowball.html", QuestionId = 167 },
                ...
                new Explanation { ExplanationId = 175, Text = "The AWS Documentation mentions the following: Amazon CloudFront employs a global network of edgelocations and regional edge caches that cache copies ofyour content close to your viewers. Amazon CloudFrontensures that end-user requests are served by the closestedge location. For more information on AWS Cloudfront, please visit the URL:https://aws.amazon.com/cloudfront/details/", QuestionId = 175 },
                ...
                new Explanation { ExplanationId = 177, Text = "When you think of cost effectiveness, you can either have to choose Spot or Reserved instances. Now whenyou have a regular processing job, the best is to use spotinstances and since your application is designed recovergracefully from Amazon EC2 instance failures, then evenif you lose the Spot instance, there is no issue becauseyour application can recover. For more information onspot instances, please visit the URL:https://aws.amazon.com/ec2/spot/", QuestionId = 177 },
                new Explanation { ExplanationId = 178, Text = "Amazon Route 53 provides highly available and scalable Domain Name System (DNS), domain name registration, and health-checking web services. It isdesigned to give developers and businesses an extremelyreliable and cost effective way to route end users toInternet applications by translating names like example.com into the numeric IP addresses, suchas 192.0.2.1, that computers use to connect to each other.For more information on Route 53, please visit the URL:https://aws.amazon.com/route53/faqs/", QuestionId = 178 },
                ...
                new Explanation { ExplanationId = 185, Text = "You can use Amazon CloudWatch Logs to monitor, store, and access your log files from Amazon Elastic Compute Cloud (Amazon EC2) instances, AWSCloudTrail, and other sources. You can then retrieve theassociated log data from CloudWatch Log For more information on AWS Cloudwatch logs visit the below https://docs . aws.amazon.com/A1nazonCloudWatch/latest/logs/WhatIsCloudWatchLogs.html", QuestionId = 185 },
                ...
                new Explanation { ExplanationId = 188, Text = "DynamoDB is a fully managed NoSQL offering provided by AWS. It is now available in most regions For users to consume. For more information on AWSDynamoDB visit the below https://aws.amazon.com/dynamodb/", QuestionId = 188 },
        ...
        private void AddQuestions()
        {
            ...
            modelBuilder.Entity<Question>().HasData(
                    ...
                    new Question { QuestionId = 13, CertificationId = 3, HasMultipleAnswers = false, Text = "Where can a customer go to get more detail about Amazon Elastic Compute Cloud (Amazon EC2)billing activity that took place 3 month ago?" },
                    ...
                    new Question { QuestionId = 18, CertificationId = 3, HasMultipleAnswers = false, Text = "Systems applying the cloud architecture principle ofelasticity will" },
                    ...
                    new Question { QuestionId = 25, CertificationId = 3, HasMultipleAnswers = false, Text = "Which of the following is a factor when calculatingTotal Cost of Ownership (TCO) for the AWSCloud?" },
                    ...
                    new Question { QuestionId = 33, CertificationId = 3, HasMultipleAnswers = false, Text = "A company is deploying a two-tier, highly availableweb application to AWS. Which service provides durable storage for static content while utilizing lower overall CPU resources for the web tier?" },
                    ...
                    new Question { QuestionId = 39, CertificationId = 3, HasMultipleAnswers = true, Text = "Which of the below can be used to get data onto Amazon Glacier? Choose 3 answers from the optionsgiven below." },
                    ...
                    new Question { QuestionId = 44, CertificationId = 3, HasMultipleAnswers = false, Text = "There is a requirement to host a database server for aminimum period of one year. Which of the following would result in the least cost" },
                    ...
                    new Question { QuestionId = 48, CertificationId = 3, HasMultipleAnswers = false, Text = "There is an external audit being carried out on your company. The IT auditor needs to have a log of all accessto the AWS resources in the companys account. Which of the below services can assist in providing the sedetails?" },
                    ...
                    new Question { QuestionId = 50, CertificationId = 3, HasMultipleAnswers = false, Text = "Your company has a set of EC2 Instances hosted inAWS. There is a requirement to create snapshots from the EBS volumes attached to these EC2 Instances in another geographical location. As per this requirement , where would you create the snapshots?" },
                    new Question { QuestionId = 51, CertificationId = 3, HasMultipleAnswers = false, Text = "A company wants to host a self-managed database inAWS. How would you ideally implement this solution?" },
                    ...
                    new Question { QuestionId = 58, CertificationId = 3, HasMultipleAnswers = false, Text = "Which of the following can be used to call AWSservices from programming languages" },
                    new Question { QuestionId = 59, CertificationId = 3, HasMultipleAnswers = false, Text = "Which of the following is the secure way of usingAWS API to call AWS services from EC2 Instances" },
